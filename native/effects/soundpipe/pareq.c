/*
 * Pareq — parametric EQ (loShelf / peaking / hiShelf).
 *
 * Extracted from the Csound opcode "pareq".
 * Original authors: Hans Mikelson, Matt Gerassimoff, Jens Groh, John ffitch, Steven Yi (2001).
 ...
 *   v    — linear amplitude gain (1.0 = 0 dB, use powf(10, dB/20) for dB input)
 *   q    — bandwidth / Q factor
 *   mode — filter type (see above)
 */
